...
/**
 * <p>
 * Ngoại lệ dùng để biểu thị trường hợp không tìm thấy tài nguyên trong hệ thống.
 * </p>
 * <ul>
 *   <li>Thường được sử dụng khi truy vấn hoặc thao tác với một tài nguyên không tồn tại.</li>
...
public class NotFoundException extends BaseException {
     ...
     */
    private static final String TAG =  NotFoundException.class.getSimpleName();
     ...
     */
    public  NotFoundException(@NonNull AppErrorInfo info) {
        super(TAG);
     ...
     */
    public  NotFoundException(@NonNull AppErrorInfo info, Object... templateArgs) {
        super(TAG);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
     ...
     */
    public  NotFoundException(@NonNull AppErrorInfo info, Throwable cause) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
     ...
     * @param templateArgs Tham số truyền vào mẫu thông báo
     */
    public  NotFoundException(@NonNull AppErrorInfo info, Throwable cause, Object... templateArgs) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
