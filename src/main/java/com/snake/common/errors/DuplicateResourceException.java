...
/**
 * <p>
 * Ngoại lệ dùng để biểu thị trường hợp tài nguyên bị trùng lặp trong hệ thống.
 * </p>
 * <ul>
 *   <li>Thường được sử dụng khi cố gắng tạo mới hoặc cập nhật một tài nguyên đã tồn tại.</li>
...
public class DuplicateResourceException extends BaseException {
     ...
     */
    private static final String TAG =  DuplicateResourceException.class.getSimpleName();
     ...
     */
    public  DuplicateResourceException(@NonNull AppErrorInfo info) {
        super(TAG);
     ...
     */
    public  DuplicateResourceException(@NonNull AppErrorInfo info, Object... templateArgs) {
        super(TAG);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
     ...
     */
    public  DuplicateResourceException(@NonNull AppErrorInfo info, Throwable cause) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
     ...
     * @param templateArgs Tham số truyền vào mẫu thông báo
     */
    public  DuplicateResourceException(@NonNull AppErrorInfo info, Throwable cause, Object... templateArgs) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
