...
/**
 * <p>
 * Ngoại lệ dùng để biểu thị trường hợp người dùng không có quyền truy cập tài nguyên hoặc thực hiện hành động.
 * </p>
 * <ul>
 *   <li>Thường được sử dụng khi người dùng bị từ chối truy cập do không đủ quyền hạn.</li>
...
public class ForbiddenException extends BaseException {
     ...
     */
    private static final String TAG =  ForbiddenException.class.getSimpleName();
     ...
     */
    public  ForbiddenException(@NonNull AppErrorInfo info) {
        super(TAG);
     ...
     */
    public  ForbiddenException(@NonNull AppErrorInfo info, Object... templateArgs) {
        super(TAG);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
     ...
     */
    public  ForbiddenException(@NonNull AppErrorInfo info, Throwable cause) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
     ...
     * @param templateArgs Tham số truyền vào mẫu thông báo
     */
    public  ForbiddenException(@NonNull AppErrorInfo info, Throwable cause, Object... templateArgs) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
