...
/**
 * <p>
 * Ngoại lệ dùng để biểu thị lỗi khi gọi tới các dịch vụ bên ngoài (external service).
 * </p>
 * <ul>
 *   <li>Thường được sử dụng khi hệ thống gặp lỗi khi giao tiếp với dịch vụ bên ngoài như API, hệ thống khác, v.v.</li>
...
public class ExternalServiceException extends BaseException {
     ...
     */
    private static final String TAG =  ExternalServiceException.class.getSimpleName();
     ...
     */
    public  ExternalServiceException(@NonNull AppErrorInfo info) {
        super(TAG);
     ...
     */
    public  ExternalServiceException(@NonNull AppErrorInfo info, Object... templateArgs) {
        super(TAG);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
     ...
     */
    public  ExternalServiceException(@NonNull AppErrorInfo info, Throwable cause) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
     ...
     * @param templateArgs Tham số truyền vào mẫu thông báo
     */
    public  ExternalServiceException(@NonNull AppErrorInfo info, Throwable cause, Object... templateArgs) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
