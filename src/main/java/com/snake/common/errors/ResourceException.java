...
/**
 * <p>
 * Ngoại lệ dùng để biểu thị các lỗi liên quan đến tài nguyên trong hệ thống.
 * </p>
 * <ul>
 *   <li>Thường được sử dụng khi thao tác với tài nguyên gặp lỗi chung không thuộc các loại ngoại lệ khác.</li>
...
public class ResourceException extends BaseException {
     ...
     */
    private static final String TAG = ResourceException.class.getSimpleName();
     ...
     */
    public ResourceException(@NonNull AppErrorInfo info) {
        super(TAG);
     ...
     */
    public ResourceException(@NonNull AppErrorInfo info, Object... templateArgs) {
        super(TAG);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
     ...
     */
    public ResourceException(@NonNull AppErrorInfo info, Throwable cause) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
     ...
     * @param templateArgs Tham số truyền vào mẫu thông báo
     */
    public ResourceException(@NonNull AppErrorInfo info, Throwable cause, Object... templateArgs) {
        super(TAG, cause);
        this.statusCode = info.getStatusCode();
        this.key = info.getKey();
        this.message = I18nProvider.getMessage(key);
